        ...
        <div class="col-lg-8 card-wrapper">
            <div class="card">
                ...
                <div class="card-body" style="text-align: center;">
                    ...
                    <?php
                    foreach ($_CONFIG["earningMethods"] as $em) {
                        echo '<a href="' . $em["link"] . '"><button type="button" class="btn btn-primary" style="margin-bottom: 10px; margin-right: 10px;"><img src="' . $em["icon"] . '" width="64"><br/><br/>' . $em["name"] . '</button></a>';
                    }
                    ?>
                </div>
            </div>
